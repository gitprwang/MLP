...
def get_dataloader(args, normalizer = 'std', tod=False, dow=False, weather=False, single=True):
    ...
    if len(x_val) == 0:
        ...
        val_dataloader = data_loader(x_val, y_val, 64, shuffle=False, drop_last=True) # args.batch_size
    test_dataloader = data_loader(x_test, y_test, 64, shuffle=False, drop_last=False)
