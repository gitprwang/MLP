...
Mode = 'train'
DEBUG = 'False'
DATASET = 'PEMSD4'      #PEMSD4, PEMSD7, PEMSD3 or PEMSD8 
DEVICE = 'cuda:0'
MODEL = 'MLP'
...
args.add_argument('--graph_conv_type', type=str, default='graph_conv', choices=['cheb_graph_conv', 'graph_conv'])
...
model = MLPResX(args.input_dim, args.output_dim, args.lag, args.horizon, args.num_nodes, d_model=64, num_layers=args.num_layers)
